<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="TimesheetSystem.Web.Custompages.Timesheet.List" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:EntityDataSource ID="GridDataSource" runat="server" EnableDelete="True" 
                ConnectionString="" DefaultContainerName="" EntitySetName="" 
